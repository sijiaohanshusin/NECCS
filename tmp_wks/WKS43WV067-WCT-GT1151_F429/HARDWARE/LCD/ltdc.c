...
{   
	...
	*/
	...
	//LTDC_Clk_Set(396,5,RCC_PLLSAIDIVR_8); //设置像素时钟 33M(如果开双显,需要降低DCLK到:18.75Mhz  300/4/4,才会比较好)
	LTDC_Clk_Set(396,3,RCC_PLLSAIDIVR_4); //设置像素时钟 9.9M   396/5/8=9.9MHz
  ...
  lcdltdc.pixsize=2;				//每个像素占2个字节
    ...
    LTDC_Handler.Init.DEPolarity=LTDC_DEPOLARITY_AL;         //数据使能极性,OK
	//LTDC_Handler.Init.DEPolarity=LTDC_DEPOLARITY_AH;
    LTDC_Handler.Init.PCPolarity=LTDC_PCPOLARITY_IPC;        //像素时钟极性,OK
